              ...
              <div className="row gy-5">
                <div className="col-xl-3 col-md-6 d-flex justify-content-center">
                  ...
                  >
                    ...
                    <p className="text">Schools using our ERP system</p>
                  </div>
                </div>
                <div className="col-xl-3 col-md-6 d-flex justify-content-center">
                  <div
                  ...
                  >
                    ...
                    <p className="text">Teachers actively managing classes</p>
                  </div>
                </div>
                <div className="col-xl-3 col-md-6 d-flex justify-content-center">
                  <div
                  ...
                  >
                    ...
                    <p className="text">
                      Students benefiting from the platform
                    </p>
                  </div>
                </div>
                <div className="col-xl-3 col-md-6 d-flex justify-content-center">
                  ...
                  >
                    ...
                    <p className="text">
                      Customer satisfaction rate from schools
                    </p>
                  </div>
                </div>
              </div>
